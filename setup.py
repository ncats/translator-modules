...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'functional_similarity = translator_modules.gene.functional_similarity:main',
            'phenotype_similarity = translator_modules.gene.phenotype_similarity:main',
            'gene_interaction=translator_modules.gene.gene_interaction:main',
