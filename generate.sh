...
CLIENT_SPECIFICATION_FILE_PATH="./reasoner_api/API/TranslatorReasonersAPI.yaml"
CLIENT_OUTPUT_DIR="client"
CLIENT_PROJECT_NAME="${PROJECT_NAME}_${CLIENT_OUTPUT_DIR}"
CLIENT_PACKAGE_NAME="ara_client"
CLIENT_PACKAGE_VERSION="0.9.2"
CLIENT_PACKAGE_URL="https://github.com/ncats/translator_modules/tree/master/client"
