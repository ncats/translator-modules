...
from translator_modules.wf9.util.bicluster_gene_to_gene import CoocurrenceByBicluster
...
class GeneToGeneBiclusters(Payload):
    ...
    def __init__(self, input_genes):
        self.mod = CoocurrenceByBicluster()
        ...
        bicluster_occurences_dict = self.mod.bicluster_occurences_dict(related_biclusters_and_genes_for_each_input_gene)
        unique_biclusters = self.mod.unique_biclusters(bicluster_occurences_dict)
