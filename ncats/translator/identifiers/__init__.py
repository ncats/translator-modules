...
class BiolinkNameSpace:
    ...
    #  TODO: temporary hack, list of URIs copied over from biolinkml project file:
    #
    #  in https://raw.githubusercontent.com/biolink/biolinkml/master/tests/test_biolink_model/source/model.py
    #
    #  Ideally, this input file should exist in the main biolink-model repository and
    #  be directly extracted for convertion to a Dict, in some fashion  similar to the following code snippet:
    #
    #    for symbol in dir(model):
    #        obj = eval("model." + symbol)
    #        if isinstance(obj, CurieNamespace):
    #            cls._namespaces[str(obj)] = obj
    #
    # Namespaces
    ...
    _namespaces = [
        ...
        CurieNamespace('OMIM', 'https://omim.org/entry/'),
        ...
        CurieNamespace('UniProtKB', 'https://www.uniprot.org/uniprot/'),
